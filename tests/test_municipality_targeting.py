...
class TestRankMunicipalitiesForOutreach:
    def test_higher_demand_elevates_lower_heuristic_municipality(self):
        ...
        profiles = [
            _profile(
                261, "Dietikon", energy_transition_score=60, leg_value_gap_chf=200
            ),
            _profile(
                247, "Schlieren", energy_transition_score=50, leg_value_gap_chf=150
            ),
        ]
    ...
    def test_demand_score_included_in_outreach_score(self):
        ...
        profiles = [
            _profile(261, "Dietikon", energy_transition_score=40, leg_value_gap_chf=100)
        ]
    ...
    def test_zero_demand_uses_heuristics_only(self):
        ...
        profiles = [
            _profile(
                261, "Dietikon", energy_transition_score=80, leg_value_gap_chf=300
            ),
            _profile(
                247, "Schlieren", energy_transition_score=40, leg_value_gap_chf=100
            ),
        ]
    ...
    def test_custom_weights_change_ranking(self):
        ...
        profiles = [
            _profile(
                261, "Dietikon", energy_transition_score=90, leg_value_gap_chf=400
            ),
            _profile(
                247, "Schlieren", energy_transition_score=10, leg_value_gap_chf=50
            ),
        ]
    ...
    def test_all_municipalities_ranked_highest_first(self):
        ...
        profiles = [
            _profile(
                261, "Dietikon", energy_transition_score=50, leg_value_gap_chf=100
            ),
            _profile(
                247, "Schlieren", energy_transition_score=70, leg_value_gap_chf=200
            ),
    ...
    def test_value_gap_normalised_to_hundred(self):
        ...
        profiles = [
            _profile(261, "Dietikon", energy_transition_score=0, leg_value_gap_chf=1000)
        ]
        demand = _demand_signals()
    ...
    def test_output_keys_present(self):
        ...
        profiles = [
            _profile(261, "Dietikon", energy_transition_score=42, leg_value_gap_chf=171)
        ]
