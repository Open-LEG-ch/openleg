...
| store/battery | 10 years (Swiss OR accounting retention; policy, not code) | Not implemented | - | Storage asset configuration and per-participant cost shares; financial configuration kept with the accounting record |
